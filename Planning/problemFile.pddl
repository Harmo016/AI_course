...
(define (problem C3_2)
  ...
  (:objects
   ...
   location1 location2 location3                          :: There are 3 locations
  ...
  (:init
   ...
   ;;uavs start unloaded in this instance
   (unloaded uav1) (unloaded uav2)

   ;; initial locations of all crates, uavs and people
   (at med_crate1 location1)  (at med_crate3 location1)
